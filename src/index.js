...
ExtendedWireframe.defaultContent = {
  ...
  projects: [
    ...
    },
    {
      ...
      text: {
        content: "Roy is totaly committed to his students. His approach is original and always right to the point, allowing me to find solutions that are systematic and easy. The wealth of knowledge Roy shared was enormous and related to today's value-based business approach. The content shared during the program will keep me applying and learning during the next year. Thank you!",
        type: 'text',
      },
      picture: {
        src: 'foto-2.jpg',
