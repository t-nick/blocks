...
ExtendedWireframe.defaultContent = {
  ...
  subtitle: {
    ...
    content: 'I have skills and experience to deal with all types of kitchen remodeling projects meeting the highest modern building industry standards.',
    color: '#cdcdcd',
  },
  why: [
    {
      title: {
        ...
        content: 'Cabinet Refacing and Replacement',
      },
      description: {
        ...Component.defaultContent.why[0].description,
        content: 'Update your kitchen style with professional cabinet resurfacing or replacement.',
      },
      icon: {
        svg:
    ...
    },
    {
      title: {
        ...Component.defaultContent.why[0].title,
        content: 'Countertop Replacement',
      },
      description: {
        ...Component.defaultContent.why[0].description,
        content: 'Create more attractive and inspiring space with the help of countertop replacement service.',
      },
      icon: {
        svg:
    ...
    },
    {
      title: {
        ...Component.defaultContent.why[0].title,
        content: 'Faucet & Fixture Replacement',
      },
      description: {
        ...Component.defaultContent.why[0].description,
        content: 'Select a new stylish sink and faucet to accent your perfect modern kitchen.',
      },
      icon: {
        svg:
    ...
    },
    {
      title: {
        ...Component.defaultContent.why[0].title,
        content: 'New Flooring Installation',
      },
      description: {
        ...Component.defaultContent.why[0].description,
        content: 'Choose from a diverse variety of flooring created to meet your home’s special style.',
      },
      icon: {
        svg:
